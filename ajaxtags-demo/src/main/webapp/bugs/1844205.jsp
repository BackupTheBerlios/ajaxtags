...
<div>
The parameter defaultOptions is now checked in the tag if you didn't pass the selecction with the xml file you can set the defaults here with a list like &lt;&lt;Explorer,RX-8&gt;&gt;
</div>
...
<ajax:select baseUrl="../dropdown.view" source="make" target="model"
	parameters="make={make}" preFunction="initProgress" defaultOptions="Explorer,RX-8"
